...
function ParkingFeedTopSection({
  messages,
  onBack,
  onClose,
  parking,
  ...
  return (
    <div className="flex flex-col gap-6 px-6 pt-6 pb-6">
      <ParkingFeedHeader messages={messages} onBack={onBack} onClose={onClose} />
      <ParkingAddressCard parking={parking} />
    </div>
  )
}

function ParkingFeedHeaderOnly({
  messages,
  onBack,
  onClose,
}: {
